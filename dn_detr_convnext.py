...
work_dir = "/root/anaconda3/oddefense/coco/black_models/dn_detr_coco_convnext"
...
test_adv_cfg = dict(
    ...
    num_steps=10,
    save_adv=True,
    save_dir="/root/anaconda3/oddefense/black_coco_datasets/adv_coco_dn_detr_convnext",
    save_ext=".png"
)
